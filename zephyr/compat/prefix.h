...
#ifdef LUA_EXCEPTION_IMPLEMENTATION_PANIC
#define LUAI_THROW(L,c) lua_compat_throw(L,c) //panics!
#define LUAI_TRY(L,c,a) { a }
#define luai_jmpbuf int //dummy, nothing stored
#endif // LUA_EXCEPTION_IMPLEMENTATION_PANIC

#ifdef LUA_EXCEPTION_IMPLEMENTATION_GCC_LONGJMP
...
#endif // LUA_EXCEPTION_IMPLEMENTATION_GCC_LONGJMP
